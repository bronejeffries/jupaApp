...
public class NewInstitutionActivity extends AppCompatActivity {
    ...
    EditText name_input, center_no_input,contact_person_input,telephone_number_input,email_input, about_input, website_input, facebook_input;
    Button save_institution;
    String nameText, centerNoText, contactPersonText, telText, emailText, aboutText, websiteText, facebookText;
    ...
    private void saveInstitution() {
        ...
        if (inputValid()){
            ...
            Institution newInstitution = new Institution(centerNoText,nameText,null,contactPersonText,telText,emailText,aboutText,websiteText,facebookText);
    ...
    public class saveInstitutions extends AsyncTask<Institution,Void,Institution>{
        ...
        protected void onPostExecute(Institution institution) {
            ...
            if (institution!=null){
                ...
                Toast.makeText(NewInstitutionActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                showProgress.dismiss();
